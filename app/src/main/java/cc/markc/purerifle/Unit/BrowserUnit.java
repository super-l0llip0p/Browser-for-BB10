...
public class BrowserUnit {
    ...
    public static final String RELATED_AGREEMENTS = "related_agreements.html";
    ...
    public static String queryWrapper(Context context, String query) {
        ...
        final int i = Integer.valueOf(sp.getString(context.getString(R.string.sp_search_engine), "3"));
        switch (i) {
            case 0:
